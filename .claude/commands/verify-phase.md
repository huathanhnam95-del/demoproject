...
<required_reading>
@C:/Users/Admin/.codex/get-shit-done/references/verification-patterns.md
@C:/Users/Admin/.codex/get-shit-done/templates/verification-report.md
</required_reading>
...
for plan in "$PHASE_DIR"/*-PLAN.md; do
  MUST_HAVES=$(node "$HOME/.codex/get-shit-done/bin/gsd-tools.cjs" frontmatter get "$plan" --field must_haves)
...
```bash
PHASE_DATA=$(node "$HOME/.codex/get-shit-done/bin/gsd-tools.cjs" roadmap get-phase "${phase_number}" --raw)
```
...
```bash
for plan in "$PHASE_DIR"/*-PLAN.md; do
  ARTIFACT_RESULT=$(node "$HOME/.codex/get-shit-done/bin/gsd-tools.cjs" verify artifacts "$plan")
...
```bash
for plan in "$PHASE_DIR"/*-PLAN.md; do
  LINKS_RESULT=$(node "$HOME/.codex/get-shit-done/bin/gsd-tools.cjs" verify key-links "$plan")
...
See C:/Users/Admin/.codex/get-shit-done/templates/verification-report.md for complete template.
</step>
