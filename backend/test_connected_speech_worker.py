...
def build_azure_payload(words):
    return {
        "NBest": [{
            "Display": " ".join(word["word"] for word in words),
...
def build_spec(reference_text, question_id, events, words, audio_quality=None):
    return {
        "attemptId": "attempt-1",
        "questionId": question_id,
        "referenceText": reference_text,
        "azurePayload": build_azure_payload(words),
        "events": events,
...
class ConnectedSpeechWorkerTest(unittest.TestCase):
    ...
    def test_family_cases(self):
        cases = [
            ...
            (
                ...
                [
                    {"word": "pick", "offset": 0, "duration": 3000000, "accuracy": 95},
                    {"word": "it", "offset": 6500000, "duration": 1800000, "accuracy": 92},
                    {"word": "up", "offset": 9300000, "duration": 2000000, "accuracy": 90},
                    {"word": "now", "offset": 11800000, "duration": 2200000, "accuracy": 93},
                ],
                "not_detected",
                "notDetectedCount",
            ),
            ...
            (
                ...
                [
                    {"word": "big", "offset": 0, "duration": 2900000, "accuracy": 94},
                    {"word": "game", "offset": 6200000, "duration": 1900000, "accuracy": 93},
                ],
                "not_detected",
                "notDetectedCount",
            ),
            ...
            (
                ...
                [
                    {"word": "green", "offset": 0, "duration": 2600000, "accuracy": 95},
                    {"word": "park", "offset": 6500000, "duration": 2200000, "accuracy": 91},
                ],
                "not_detected",
                "notDetectedCount",
            ),
            ...
            (
                ...
                [
                    {"word": "would", "offset": 0, "duration": 2400000, "accuracy": 95},
                    {"word": "you", "offset": 6500000, "duration": 1600000, "accuracy": 90},
                ],
                "not_detected",
                "notDetectedCount",
            ),
            ...
            (
                ...
                [
                    {"word": "want", "offset": 0, "duration": 2500000, "accuracy": 94},
                    {"word": "to", "offset": 3900000, "duration": 3400000, "accuracy": 95},
                    {"word": "go", "offset": 7700000, "duration": 2600000, "accuracy": 92},
                ],
                "not_detected",
                "notDetectedCount",
            ),
    ...
    def test_phoneme_hint_can_flip_borderline_yod(self):
        spec = build_spec(
            "Did you see it?",
            "q-1",
            [{
