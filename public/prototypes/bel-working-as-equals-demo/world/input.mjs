export function installInput(canvas,{interact,escape,release,blocked}){
  ...
  const click=e=>{canvas.focus();if(blocked()||Date.now()-lastInteract<350)return;lastInteract=Date.now();const b=canvas.getBoundingClientRect();interact({x:(e.clientX-b.left)*1000/b.width,y:(e.clientY-b.top)*480/b.height,clientX:e.clientX,clientY:e.clientY,offsetX:e.clientX-b.left,offsetY:e.clientY-b.top,width:b.width,height:b.height});};
