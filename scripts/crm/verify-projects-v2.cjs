...
const nodeChecks = [
    ['focused', ['v2-row-editors', 'v2-quick-create', 'v2-task-detail', 'v2-views-navigation', 'v2-automations', 'v2-mobile-accessibility', 'v2-performance-reconciliation', 'v2-rollout-readiness']],
