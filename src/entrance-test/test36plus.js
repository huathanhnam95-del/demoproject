    ...
    sections: [
        ...
        },
        {
            ...
            questions: [
                {
                    id: 'vocab_q1',
                    raw: 'Most groups of animals have their specialist feeders adapted to a very limited type of food. Among __insects/reptiles/mammals/primates__, perhaps the most extraordinary is an African egg-eating snake. Many snakes eat eggs as part of a varied __habit/diet/tradition/plan__ but the egg eater eats exclusively eggs. Small, soft-shelled eggs are __hard/slow/easy/difficult__ to eat, as they can be quickly opened by the snake’s teeth. Larger, hard-shelled eggs such as those laid by birds need special treatment. However, some types of egg-eating snakes eat only birds’ eggs which they swallow whole as they have few teeth. They have tooth-like spines that stick down from the backbone and crack open the egg as it passes down the snake’s __eyes/lungs/throat/nose__.'
                },
                {
                    id: 'vocab_q2',
                    raw: 'Used in a variety of courses in various disciplines, Asking The Right Questions helps students __bridge/widen/spoil/leak__ the gap between simply memorizing or blindly accepting information, and the greater challenge of critical analysis and synthesis. Specifically, this concise text teaches students to think __importantly/critically/crucially/essentially__ by exploring the components of arguments - issues, conclusions, reasons, evidence, assumptions, language - and on how to spot fallacies, manipulations, and obstacles to critical thinking in both written and visual communication. It teaches them to respond to alternative points of view and develop a solid foundation for making personal choices about what to accept and what to __reflect/remake/respond/reject__.'
                },
                {
                    id: 'vocab_q3',
                    raw: 'A creature may have fine __mental/chemical/physical/spiritual__ defenses such as hard armor or sharp spines. It may have powerful chemical defenses such as an __appalling/appealing/attractive/appetizing__ smell or foul-tasting flesh. But none of these defenses is much used in a struggle for survival unless the animal also has the right behavior to go with it. Evolution shapes a living creature\'s size, colour, and other features. It also shapes an animal’s actions and behavior patterns. The most important behaviors are __acquired/extrinsic/intuitive/instinctive__ and inbuilt. In other words, the creature can perform the action without having to learn what to do and how to do it by __effort/trial/attempt/encouragement__ and error.'
                },
                {
                    id: 'vocab_q4',
                    raw: 'DNA is a molecule that does two things. First, it acts as the __building/hereditary/metabolic/nutritional__ material, which is passed __out/down/around/by__ from generation to generation. Second, it directs, to a considerable extent, the construction of our bodies, telling our cells what kinds of molecules to make and guiding our development from a single-celled zygote to a fully formed adult. These two things are, of course, connected. The DNA sequences that construct the best bodies are more likely to get passed down to the next generation because well-constructed bodies are more likely to __survive/exist/wither/multiply__ and thus to reproduce. This is Darwin’s __hypothesis/statement/thesis/theory__ of natural selection stated in the language of DNA.'
                }
            ]
        },
        {
