...
const grammarModule = require('../../public/js/read-aloud-prompt-grammar.js');
const linkingModule = require('../../public/js/read-aloud-linking.js');

const OVERRIDES_PATH = path.join(__dirname, '../../data/read-aloud/connected-speech-overrides.json');
const VERSION = 'cs-v1';
...
const REDUCED_WORDS = new Map([
  ['a', ['canonical', 'reduced_a']], ['an', ['canonical', 'reduced_an']],
  ['the', ['canonical', 'reduced_the']], ['to', ['canonical', 'reduced_to']],
  ['and', ['canonical', 'reduced_and']], ['of', ['canonical', 'reduced_of']],
  ['for', ['canonical', 'reduced_for']], ['can', ['canonical', 'reduced_can']],
  ['have', ['canonical', 'reduced_have']], ['has', ['canonical', 'reduced_has']],
  ['was', ['canonical', 'reduced_was']], ['were', ['canonical', 'reduced_were']],
