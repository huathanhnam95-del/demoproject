...
(async () => {
  ...
  try {
    ...
    await page.click('#essay-ai-score-btn');
    await page.waitForFunction(() => document.querySelector('#essay-ai-score-status')?.textContent.includes('Queued for local AI scoring'));
