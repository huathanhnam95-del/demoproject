...
expectRoute(routes, 'GET /accounts');
expectRoute(routes, 'PATCH /accounts/:uid/role');
...
expectRoute(routes, 'GET /agent-sources/report');
...
expectRoute(routes, 'GET /recycle-bin');
expectRoute(routes, 'POST /recycle-bin/restore');
expectRoute(routes, 'POST /recycle-bin/purge');
