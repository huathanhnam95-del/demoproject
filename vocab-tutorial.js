...
(function () {
    ...
    function markCompleted(tutorialId) {
        ...
        saveState(state);
        console.log(`[VocabTutorial] Marked ${tutorialId} as completed`);
    }
    ...
    function resetTutorial(tutorialId) {
        ...
        saveState(state);
        console.log(`[VocabTutorial] Reset ${tutorialId}`);
    }
    ...
    function resetAll() {
        ...
        console.log('[VocabTutorial] All tutorials reset');
    }
    ...
    function startTutorial(tutorialId) {
        ...
        if (!tutorialDef) {
            console.error(`[VocabTutorial] Unknown tutorial: ${tutorialId}`);
            return;
        }

        // Check if should show
        if (!shouldShow(tutorialId)) {
            console.log(`[VocabTutorial] ${tutorialId} already completed, skipping`);
            return;
        }

        console.log(`[VocabTutorial] Starting ${tutorialId}...`);

        initElements();

        if (!overlay) {
            console.error('[VocabTutorial] Overlay element not found');
            return;
        }
    ...
    function showStep(index) {
        ...
        if (step.skipIfMissing && step.target) {
            ...
            if (!targetEl) {
                console.log(`[VocabTutorial] Skipping step ${index} - target missing`);
                currentStep++;
                showStep(currentStep);
                return;
            }
        ...
        Object.entries(toggleIds).forEach(([toggleId, tutorialId]) => {
            ...
            if (toggle) {
                ...
                toggle.addEventListener('change', () => {
                    ...
                    console.log(`[VocabTutorial] Replay ${tutorialId}: ${toggle.checked}`);
                });
            }
        });
    }
